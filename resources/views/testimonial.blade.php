	...
	<div class="page-area contact-page">
		...
		<div class="container spad">
			<div class="text-center">
				<h4 class="contact-title">Make a Testimonial</h4>
			</div>
			<form class="contact-form" method="POST" action="/testimonial">
				@csrf
				<div class="row">
					<div class="col-md-12">
						<input type="text" placeholder="Subject" name="fullname">
						<textarea placeholder="Description" name="description"></textarea>
						<div class="text-center">
							<button class="site-btn">Send Testimonial</button>
						</div>
					</div>
				</div>
			</form>
