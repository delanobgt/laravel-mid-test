						...
						@foreach ($cartCount as $key => $cc)
							<tr>
								<td class="product-col">
									<img src="{{ asset($products[$key]['img']) }}" alt="">
									<div class="pc-title">
										<h4>{{ $products[$key]['name'] }}</h4>
										<a href="#">Edit Product</a>
									</div>
								</td>
								<td class="price-col">${{ $products[$key]['price'] }}</td>
								<td class="quy-col">
									<div class="quy-input">
										<span>Qty</span>
								...
								<td class="total-col">${{ $products[$key]['price'] * $cc }}</td>
							</tr>
						@endforeach
					</tbody>
				</table>
						...
						<div class="shipping-info">
							...
							<div class="shipping-chooes">
								<div class="sc-item">
									...
									<label for="three">Free Delivery<span>Free</span></label>
								</div>
							</div>
							<h4>Cupon code</h4>
